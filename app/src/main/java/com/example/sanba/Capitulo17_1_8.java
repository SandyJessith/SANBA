...
public class Capitulo17_1_8 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_capitulo17_1_8);
        ...
        btnVolverBuque.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(Capitulo17_1_8.this, Buque.class);
